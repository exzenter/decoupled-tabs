          ...
          {gsapEnabled && (
            <>
              ...
              <ToggleControl
                ...
                onChange={(value) => setAttributes({ gsapSplitLines: value })}
              />
              <ToggleControl
              ...
              <SelectControl
                ...
                options={[
                  {
                    label: __('Same Duration', 'decoupled-tabs'),
                    value: 'same-duration',
                  },
                  {
                    label: __('Same Speed', 'decoupled-tabs'),
                    value: 'same-speed',
                  },
                ]}
                onChange={(value) => setAttributes({ gsapTimingMode: value })}
              />
              <RangeControl
